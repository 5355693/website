...
---
*This post originally appeared as an article in the April 2021 issue of [Birdwatching Magazine](https://www.birdwatchingdaily.com/the-magazine/current-issue/). This is the first non-scholarly article that I've published and it allows me to claim, in all honesty, that I am a professional writer. At last. It looks even better in the magazine, by the way.* 
...
`r blogdown::shortcode("figure", src = "/img/tunnelOfMangroves.JPG", caption = "A lane of open water cuts through a forest of red mangrove in south Florida.")`
...
Welcome to Mangrove Cuckoo country.
...
`r blogdown::shortcode("figure", src = "/img/cuckoos1asm.jpg", caption = "A peek into the secret life of the elusive Mangrove Cuckoo. Here, two birds engage in a bit of foreplay. The male, grasping the back of his mate, offers a bit of food as an enticement. If she accepts, this courtship feeding is a precursor to mating.")`
...
`r blogdown::shortcode("figure", src = "/img/disturbedMangroves.JPG", caption = "A reminder of why we stick to the tidal creeks: foot travel through the flooded, snarled tangle that is a mangrove forest is impossible.")`
